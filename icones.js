/* Ícones SVG (Lucide, ISC). A skill ui-ux-pro-max marca emoji-como-ícone
 * como anti-padrão: não escala, não herda cor, e o leitor de tela anuncia
 * o nome do emoji. Estes herdam currentColor e são aria-hidden por padrão —
 * o rótulo acessível vem do texto ao lado ou de aria-label no botão. */

const P = {
  home: '<path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><path d="M9 22V12h6v10"/>',
  cartao: '<rect width="20" height="14" x="2" y="5" rx="2"/><line x1="2" x2="22" y1="10" y2="10"/>',
  comparar: '<path d="M8 3 4 7l4 4"/><path d="M4 7h16"/><path d="m16 21 4-4-4-4"/><path d="M20 17H4"/>',
  ...
  lista: '<line x1="8" x2="21" y1="6" y2="6"/><line x1="8" x2="21" y1="12" y2="12"/><line x1="8" x2="21" y1="18" y2="18"/><line x1="3" x2="3.01" y1="6" y2="6"/><line x1="3" x2="3.01" y1="12" y2="12"/><line x1="3" x2="3.01" y1="18" y2="18"/>',
  ...
  moeda: '<circle cx="12" cy="12" r="10"/><path d="M16 8h-6a2 2 0 1 0 0 4h4a2 2 0 1 1 0 4H8"/><path d="M12 18V6"/>',
  ...
  saida: '<path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"/><path d="m10 17 5-5-5-5"/><path d="M15 12H3"/>',
...
// "casa" é o mesmo desenho de "home": o app usa o nome em português.
P.casa = P.home


/** Devolve o markup de um ícone. `rotulo` torna o ícone anunciável; sem ele,
 *  fica aria-hidden (caso em que o texto ao lado já descreve a ação). */
export function ic(nome, { classe = 'ic', rotulo = null } = {}) {
  const d = P[nome]
  if (!d) return ''
  const a11y = rotulo ? `role="img" aria-label="${rotulo}"` : 'aria-hidden="true"'
  return `<svg class="${classe}" viewBox="0 0 24 24" ${a11y}>${d}</svg>`
}

export const ICONES = P
